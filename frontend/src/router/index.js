...
const routes = [
  { path: '/', component: () => import('../views/Layout.vue'), meta: { requiresAuth: false },
    children: [
      ...
      { path: 'my-history', name: 'MyHistory', component: () => import('../views/MyHistory.vue') },
      ...
      { path: 'my-invoices', name: 'MyInvoices', component: () => import('../views/MyInvoices.vue'), meta: { requiresAuth: true } },
      { path: 'invoices/apply', name: 'InvoiceApply', component: () => import('../views/InvoiceApply.vue'), meta: { requiresAuth: true } },
      { path: 'invoices/:id/edit', name: 'InvoiceEdit', component: () => import('../views/InvoiceApply.vue'), meta: { requiresAuth: true } },
      { path: 'admin/users', name: 'AdminUsers', component: () => import('../views/AdminUsers.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
      { path: 'admin/invoices', name: 'AdminInvoices', component: () => import('../views/AdminInvoices.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
